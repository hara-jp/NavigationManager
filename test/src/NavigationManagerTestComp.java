// -*- Java -*-
/*!
 * @file NavigationManagerTestComp.java
...
/*!
 * @class NavigationManagerTestComp
 * @brief Standalone component Class
 *
 */
public class NavigationManagerTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(NavigationManagerTest.component_conf);
      mgr.registerFactory(prop, new NavigationManagerTest(), new NavigationManagerTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("NavigationManagerTest");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        NavigationManagerTestComp init = new NavigationManagerTestComp();
